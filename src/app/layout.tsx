            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><Link href="/productos?cat=packaging" className="hover:text-amber-400">Playo y Embalaje</Link></li>
                  <li><Link href="/productos?cat=protection" className="hover:text-amber-400">Esquineros y Protección</Link></li>
                  <li><Link href="/productos?cat=tape" className="hover:text-amber-400">Cintas Adhesivas</Link></li>
                  <li><Link href="/productos?cat=containers" className="hover:text-amber-400">Cubetas y Contenedores</Link></li>
                </ul>
              </div>
              <div>
